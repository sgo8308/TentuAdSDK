...
public class BigAdPanel : MonoBehaviour
{
    ...
    IEnumerator ShowAdChain(string url, string userId, System.Action<TentuAdApi.NativeAdData> var)
    {
        ...
        StartCoroutine(fApi.sendShowAd(panelAdData.apps[0].urlImgWide, "BigAd"));//광고 정보 갖고오면 이미지url넣어서 보여준다.
        Debug.Log("urlImgWide는 : " + panelAdData.apps[0].urlImgWide);
    }


    /*광고판 광고에서 Install Now 클릭시 연결된 URL로 이동*/
    ...
    string MakeUrl()
    {
        ...
        {
            //Category 여러개 -> lockcat=Social,Travel
            url = "https://global.appnext.com/offerWallApi.aspx?" +
                  "tid=API&did=03382e13-716f-47c0-8b40-10ca1ad1abe1&" +
                  "id=99dd343b-c93a-418f-b393-19f968a387f3&" +
                  "ip=92.38.148.61&" +
                  "lockcat=Social&" +
                  "uagent=Dalvik%2f2.1.0+(Linux%3b+U%3b+Android+9%3b+Redmi+Note+7+Pro+MIUI%2fV10.3.9.0.PFHINXM)";
        }
